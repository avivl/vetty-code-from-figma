  ...
  render() {
    ...
    return (
      <div className="company-logo-9">
        ...
        />
        <div className="charming-and-comfort-18 valign-text-middle redhatdisplay-extra-bold-mirage-22px">Vetti</div>
      </div>
    );
  }
}
