...
import "./Dashboard3Empty.sass";

class Dashboard3Empty extends React.Component {
  render() {
    const {
      a1E5Ce627F3Fd3Fb5E05D6Ae03Dde4Bf1,
      text1,
      text2,
          ...
          <div className="section-44">
            <div className="container-23">
              <div className="sections-2">
                ...
                />
                <div className="section-45">
                  <div className="container-24">
                    <div className="table-1 border-1px-gallery">
                      ...
                      />
                      <div className="filters-bar-1"></div>
                      <div className="content-106">
                        ...
                        <div className="overlap-group1-3">
                          ...
                          <div className="overlap-group-19">
                            ...
                            <div className="frame-33766">
                              <img
                                className="a1e5ce627f3fd3fb5e05d6ae03dde4bf-1"
                                src={a1E5Ce627F3Fd3Fb5E05D6Ae03Dde4Bf1}
                              />
                              <div className="text-153 inter-medium-mirage-18px">{text1}</div>
                              <p className="text-154 inter-normal-pale-sky-16px">{text2}</p>
                            </div>
                          </div>
                        </div>
