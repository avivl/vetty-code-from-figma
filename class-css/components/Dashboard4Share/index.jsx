      ...
      <div className="container-center-horizontal">
        <div className="dashboard-4-share screen">
          <div className="overlap-group1-2">
            <div className="header-navigation-10">
              ...
              <img className="divider-30" src={divider} />
            </div>
              ...
              <div className="section-42">
                <div className="container-21">
                  <div className="sections-1">
                    ...
                    />
                    <div className="section-43">
                      <div className="container-22">
                        <div className="table border-1px-gallery">
                          <SupportingTextFalseStyleSimpleActio
            ...
            <div className="modal-2">
              <img className="share-project-11" src={shareProject} />
            </div>
          </div>
        </div>
      </div>
