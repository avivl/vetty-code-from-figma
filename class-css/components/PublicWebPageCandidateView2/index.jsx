        ...
        <div className="public-web-page-candidate-view screen">
          <div className="header-navigation-8">
            <div className="container-18">
              <Content8 className={content8Props.className} content32Props={content8Props.content32Props} />
              <Content11 />
            </div>
            <img className="divider-26" src={divider} />
          </div>
          <div className="container-19">
            <div className="content-89">
              ...
              />
              <div className="divider-27"></div>
            </div>
          </div>
          <div className="flex-row-5">
            <img className="group-75-3" src={group75} />
            ...
            <img className="graphics-3" src={graphics} />
          </div>
        </div>
      </div>
    );
