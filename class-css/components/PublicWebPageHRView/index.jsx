...
import TypeLeadingTextLeadingIconFalseLabe from "../TypeLeadingTextLeadingIconFalseLabe";
...
import LabelTrueHintTextFalseDestructiveFa from "../LabelTrueHintTextFalseDestructiveFa";
import LabelTrueHintTextFalseDestructiveFa2 from "../LabelTrueHintTextFalseDestructiveFa2";
import Footer from "../Footer";
import Frame33760 from "../Frame33760";
import "./PublicWebPageHRView.css";
      ...
      <div className="container-center-horizontal">
        <div className="public-web-page-hr-view-1 screen">
            ...
            <div className="content-3">
              <div className="heading">
                <div className="text-and-supporting-text-1">
                  <div className="text-10 inter-medium-mirage-24px">{text}</div>
                </div>
                <Button />
          ...
          <div className="flex-row">
            <img className="group-75" src={group75} />
              ...
              <div className="applicant-details">
                <div className="frame-33765">
                  ...
                  <div className="frame-33764">
                    ...
                    />
                    <div className="frame-33765-1">
                      <InputDropdown />
                    </div>
                  </div>
                  <LabelTrueHintTextFalseDestructiveFa
                    destructiveFalse62Props={labelTrueHintTextFalseDestructiveFa.destructiveFalse62Props}
                  />
                  <LabelTrueHintTextFalseDestructiveFa2
                    destructiveFalse2Props={labelTrueHintTextFalseDestructiveFa2.destructiveFalse2Props}
                  />
                  <LabelTrueHintTextFalseDestructiveFa2
                    destructiveFalse2Props={labelTrueHintTextFalseDestructiveFa3.destructiveFalse2Props}
                  />
                </div>
              </div>
            ...
            />
            <img className="graphics" src={graphics} />
          </div>
        </div>
      </div>
    );
